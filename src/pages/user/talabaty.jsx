...
import { Search, Settings, Heart, MessageSquare, FolderCheck, Hammer } from 'lucide-react';
      ...
      {activeTab === 'talabaty' ? (
        <>
          ...
          <div className="mt-8 flex items-center justify-between text-sm text-gray-500">
            <div>
              عرض {Math.min((currentPage - 1) * itemsPerPage + 1, filteredServices.length)} إلى{' '}
              ...
              {Array.from({ length: totalPages }).map((_, i) => (
                <button
                  ...
                  className={`px-3 py-2 border rounded-lg hover:bg-gray-100 transition-colors ${
                    currentPage === i + 1 ? 'bg-blue-100 border-blue-300 text-blue-700 font-semibold' : 'border-gray-300'
                  }`}
