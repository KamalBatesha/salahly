...
const Orders = () => {
  ...
  const [allOrders] = useState([...Array(50)].map((_, i) => ({
    ...
    location: `شارع ${45 + i}، اسكندرية`,
    cost: `${2000 + (i * 100)}`,
    email: 'Sophie40@yahoo.com',
    phone: '01222222222',
    description: 'Lorem ipsum dolor sit amet consectetur. Eu praesent lorem quisque praesent dolor ultrices nam urna auctor.'
  })));
