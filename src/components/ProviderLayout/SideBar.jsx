...
export const Sidebar = ({ isOpen }) => {
    ...
    const mainMenu = [
        ...
        { id: 'applications', icon: 'menu-board-filled.png', activeIcon: 'menu-board.png', label: 'طلباتى' },  
        // , path: '/orders'
        { id: 'reports', icon: 'category-filled.png', activeIcon: 'category.png', label: 'خدماتى', path: '/my-services' },
