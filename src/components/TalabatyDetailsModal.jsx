          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <div className="flex-1 mx-4 text-right">
              <p className="text-sm font-semibold text-gray-800">
                {service.technicianName || "اسم الفني"}
              </p>
              <p className="text-xs text-gray-500">
                {service.location || "الرياض"}، {service.serviceName || "خدمة"}
              </p>
            </div>
            {/* Details Button */}
        ...
        <div className="p-6 grid grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500 leading-relaxed text-right">
              {service.description || "لا توجد تفاصيل إضافية."}
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center text-sm text-gray-700">
              <div className="text-sm text-black">{service.serviceName || "خدمة"}</div>
