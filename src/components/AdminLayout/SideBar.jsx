...
=======
  const mainMenu = [
    ...
    {
      id: "statistics",
      icon: "service-provider-filled.png",
      activeIcon: "service-provider.png",
      label: "الصنايعية",
      path: "/providers",
    },
    {
      id: "students",
      icon: "clients-filled.png",
      activeIcon: "clients.png",
      label: "العملاء",
      path: "/clients",
    },
    {
      id: "applications",
      icon: "menu-board-filled.png",
      activeIcon: "menu-board.png",
      label: "الطلبات",
      path: "/orders",
    },
    {
      id: "reports",
      icon: "category-filled.png",
      activeIcon: "category.png",
      label: "تخصص",
      path: "/categories",
    },
    {
      id: "reports",
      icon: "profile-filled.png",
      activeIcon: "profile.png",
      label: "خدمات",
      path: "/services",
    },
  ];
>>>>>>> origin/AdminServiceV2
...
=======
      ...
      return (
        <button
          ...
          className={`w-full flex flex-row-reverse items-center gap-3 px-3 py-3 rounded-lg transition-colors text-sm
                    ${
                      active
                        ? "bg-[#004AAD] text-white text-lg font-bold"
  ...
  return (
    <div
      className={`fixed right-0 top-0 h-full bg-white shadow-lg border-l border-gray-200 transition-all duration-300 z-40 
            ${
              isOpen ? "w-50" : "w-0"
            } overflow-hidden rounded-tl-3xl rounded-bl-2xl flex flex-col justify-between`}
    >
      {/* Logo */}
      <div>
        <div className="h-18 border-b border-gray-200 flex items-center justify-center p-4">
        ...
        {/* Main menu */}
        <div className="p-4">
          <nav className="space-y-2">{renderMenuItems(mainMenu)}</nav>
        </div>
      </div>

      {/* Bottom menu */}
      <div className="p-4  border-gray-100">
        <nav className="space-y-2">{renderMenuItems(bottomMenu)}</nav>
      </div>
    </div>
  );
};
